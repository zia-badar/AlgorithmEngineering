...
void permutations(int r, vector<string> values, vector<string> permutation, set<vector<string>> &result_permutations, bool repeatition_allowed = false)
{
    if (r < 0)
    {
...
vector<vector<string>> generate_permutations_of_demerge()
{
    ...
    vector<vector<string>> demerge_permutations = cartesian_product(before_merge_permutations, after_merge_permutations);
